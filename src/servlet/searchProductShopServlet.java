...
/**
 * Servlet implementation class searchProductShopServlet
 */
@WebServlet("/searchProductShopServlet")
public class searchProductShopServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchProductShopServlet() {
        super();
