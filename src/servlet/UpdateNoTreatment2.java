...
/**
 * Servlet implementation class UpdateNoTreatment2
 */
@WebServlet("/UpdateNoTreatment2")
public class UpdateNoTreatment2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateNoTreatment2() {
        super();
