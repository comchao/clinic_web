...
if(produc_month.equals("01")){ %>
	<h4>การจ่ายยา ประจำเดือน  มกราคม  ปี    <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("02")){ %>
	<h4>การจ่ายยา ประจำเดือน  กุมภาพันธ์  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("03")){ %>
	<h4>การจ่ายยา ประจำเดือน  มีนาคม  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("04")){ %>
	<h4>การจ่ายยา ประจำเดือน เมษายน  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("05")){ %>
	<h4>การจ่ายยา ประจำเดือน  พฤษภาคม  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("06")){ %>
	<h4>การจ่ายยา ประจำเดือน  มิถุนายน  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("07")){ %>
	<h4>การจ่ายยา ประจำเดือน  กรกฎาคม  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("08")){ %>
	<h4>การจ่ายยา ประจำเดือน  สิงหาคม  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("09")){ %>
	<h4>การจ่ายยา ประจำเดือน  กันยายน  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("10")){ %>
	<h4>การจ่ายยา ประจำเดือน  ตุลาคม  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("11")){ %>
	<h4>การจ่ายยา  ประจำเดือน  พฤศจิกายน  ปี  <%= produc_year%> </h4>
	
	
<% } %>
<%if(produc_month.equals("12")){ %>
	<h4>การจ่ายยา ประจำเดือน  ธันวาคม  ปี  <%= produc_year%> </h4>
	<%} %>
...
var chart = AmCharts.makeChart("chartdiv", {
	  ...
	  <%if(chart_id!=null){ 
		  ...
		  DrugDAO dao = new DrugDAO();  
			List<DrugBean> list = dao.treatmentCharPie(produc_month,produc_year ,ON);
			response.setCharacterEncoding("utf-8");
			JSONArray ja = new JSONArray();

			for(int i=0;i<list.size();i++){
				DrugBean bean = list.get(i);
...
<!-- ส่วนของ  chartdiv -->
  ...
  <%if(chart_id!=null){ 
	  ...
	  DrugDAO dao2 = new DrugDAO();  
		List<DrugBean> list2 = dao2.treatmentCharPie(produc_month,produc_year ,ON );
		response.setCharacterEncoding("utf-8");
		
		

			for(int i2=0;i2<list.size();i2++){
				DrugBean bean2 = list2.get(i2);
