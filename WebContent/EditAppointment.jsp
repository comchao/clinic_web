...
<body>
	...
	response.setCharacterEncoding("UTF-8");
		...
		String title = new String(request.getParameter("title").getBytes("ISO8859_1"), "UTF8");
	
		String Date = request.getParameter("Date");
		String note = new String(request.getParameter("note").getBytes("ISO8859_1"), "UTF8");
	%>
...
<input name="id_auto" type="hidden" value="<%=id_auto%>">




							<b><input name="" type="text" class="form-control"
								value="<%="ชื่อเจ้าของสัตว์:&nbsp;" + bean.getOwners_name() + "&nbsp;&nbsp;" + bean.getOwners_lname()%>"
								readonly="readonly" style="background: #CCFFCC" /> </b> <input
								name="id" type="hidden" value="<%=bean.getId()%>">
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							...
							<input name="Close" type="text" class="form-control"
								value="<%="เบอร์ติดต่อ:&nbsp;&nbsp;&nbsp;" + bean8.getTelephon()%>"
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							...
							%>
							<b><input name="Close" type="text" class="form-control"
								value="<%="แพทย์ผู้นัด:&nbsp;&nbsp;" + bean9.getMem_name() + "&nbsp;&nbsp;" + bean9.getMem_lname()%>"
								readonly="readonly" style="background: #FF9999" /> </b> <input
								name="idmenber" type="hidden" value="<%=idmenber%>">
							<!-- ตัวแปรเพิ่มข้อมูลนัดหมาย -->
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							<input name="Close" type="text" class="form-control"
								value="<%="ตำแหน่ง:&nbsp;&nbsp;" + bean11.getMem_position()%>"
								readonly="readonly" />
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							...
							%>
							<B><input name="Close" type="text" class="form-control"
								value="<%="ชื่อสัตว์เลี้ยง:&nbsp;&nbsp;" + bean2.getPet_name()%>"
								readonly="readonly" style="background: #CCFFCC" /> </B>
							<%
								}
							%>
						</div>
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							...
							%>
							<input name="Close" type="text" class="form-control"
								value="<%="ประเภท:&nbsp;&nbsp;" + bean3.getPet_category()%>"
								readonly="readonly" />
							<%
								}
							%>
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							<b><input name="date" type="text" class="form-control"
								value="<%=Date%>" id="dateInput"  required="required"/> <!-- ตัวแปรเพิ่มข้อมูลนัดหมาย -->
							</b>
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							...
							%>
							<input name="Close" type="text" class="form-control"
								value="<%="อายุ:&nbsp;&nbsp;" + bean6.getPet_age()%>"
								readonly="readonly" /> <input name="id_ownerdata" type="hidden"
								value="<%=bean6.getOwner_id()%>">
							<!-- ตัวแปรเพิ่มข้อมูลนัดหมาย -->
			...
			<center><input type="submit" class="btn btn-success"  value="แก้ไข"></center>
