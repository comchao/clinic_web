...
<tr>
					...
					<!-- <td><a href=""><input type="submit" class="btn btn-success" value="รับเรื่อง" /></td> -->
					<td> 

<!-- Trigger/Open The Modal -->
<%-- <button id="myBtn">ดูรายละเอียด</button>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <center><h3>รายละเอียดการนัดหมาย</h3></center>
    </div>
    <div class="modal-body">
      <p><%=bean.getId()%></p>
					<p><%=bean.getId_calendar()%></p>
					<p><%=bean.getUrl()%></p>
					<p><%=bean.getTitle()%></p>
					<p><%=bean.getDate()%></p>
