...
<br><br><br>
	...
	<center>
		...
		<div class="container">
			...
			<h3 align="center">แก้ไขข้อมูลนัดหมายสัตว์เลี้ยง</h3>
			...
			<div class="row">
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							<input name="title" type="text" class="form-control" value="<%="เรื่องที่นัด"+title%>"
								 readonly="readonly" />
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="form-group" style="text-align: center">
							<b><input name="date" type="text" class="form-control"
								value="<%="วันนัด"+Date%>"  readonly="readonly"  /> <!-- ตัวแปรเพิ่มข้อมูลนัดหมาย -->
							</b>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group" style="text-align: center">
							<center>
								<input name="note" type="text" class="form-control" value="<%="หมายเหตุ"+note%>"
										readonly="readonly"/>
								<!-- ตัวแปรเพิ่มข้อมูลนัดหมาย -->
							</center>
						</div>
