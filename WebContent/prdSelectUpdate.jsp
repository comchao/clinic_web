...
<script>
	function updateCage() {
		...
		window.opener.document.frmMain.pro_name.value = document.frmMain.pro_name.value;
		window.opener.document.frmMain.product_price.value = document.frmMain.product_price.value;
		window.opener.document.frmMain.product_qty.value = document.frmMain.product_qty.value;
		window.opener.document.frmMain.total_total.value = ((document.frmMain.product_price.value)*(document.frmMain.product_qty.value));
		window.close();
	}
</script>
<br><br>
...
<form name="frmMain" method="post" action="">
	...
	<input type="hidden" name="refer_petdeposit" id="refer_petdeposit"
										placeholder="ประเภทสัตว์เลี้ยง " class="form-control"
										value="<%=Integer.parseInt(request.getParameter("refer_petdeposit"))%>">
	<input type="hidden" name="txtSum" id="txtSum"
										placeholder="ประเภทสัตว์เลี้ยง " class="form-control"
										value="">
...
<script>
	$(document).ready(function() {
		...
		document.frmMain.prd_date.value=currentDate;
