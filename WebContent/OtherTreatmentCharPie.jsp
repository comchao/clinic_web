...
var chart = AmCharts.makeChart("chartdiv", {
	  ...
	  <%if(chart_id!=null){ 
		  ...
		  TreatmentDao dao = new TreatmentDao();  
			List<OtherTreatment> list = dao.OtherTreatmentCharPie(produc_month,produc_year,ON);
			response.setCharacterEncoding("utf-8");
...
<!-- ส่วนของ  chartdiv -->
  ...
  <%if(chart_id!=null){ 
	  ...
	  TreatmentDao dao2 = new TreatmentDao();  
			List<OtherTreatment> list2 = dao.OtherTreatmentCharPie(produc_month,produc_year,ON);
			response.setCharacterEncoding("utf-8");
		

			for(int i2=0;i2<list.size();i2++){
				OtherTreatment bean2 = list2.get(i2);
