	...
	<div class="row">
		...
		<div class="col-sm-6"><h4 align="center">ค้นหาข้อมูลเจ้าของ</h4>
			...
			<form action="SearchOwnerServlet" method="post">
				<input name="owner_name" type="text" class="form-control" style="width:70%;" placeholder="ชื่อเจ้าของสัตว์เลี้ยง,หมายเลขบัตรประชาชน,เบอร์โทรศัพท์" style="width:70%;" required="required"/> 
		...
		<div class="col-sm-6"><h4 align="center">ค้นหาข้อมูลสัตว์เลี้ยง</h4>
			...
			<form action="SearchPetServlet" method="post">
				<input name="pet_name" type="text" placeholder="ชื่อสัตว์เลี้ยง" class="form-control" style="width:70%;" required="required"/> 
