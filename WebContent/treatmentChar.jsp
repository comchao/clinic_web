...
<% } %>
<%if(produc_month.equals("02")){ %>
	<h4>การจ่ายยาประจำเดือน  กุมภาพันธ์  ปี  <%= produc_year%> </h4>
...
<tr>
	  ...
	  <tbody>
			...
			List<DrugBean> list = dao.treatmentChar(produc_month,produc_year,ON);
			response.setCharacterEncoding("utf-8");
