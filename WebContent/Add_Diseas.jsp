...
li.sortable-placeholder {
	...
	<form action="AddDiseaseServlet" method="post">

		<div class="col-lg-12">
		
						<h4>
							<b>เพิ่มโรคสัตว์เลี้ยง</b>
						</h4>
					</div>
  ...
  <tr id="firstTr">  
   <td width="">
    <td width="600"><div class="col-sm-6">
								...
								<center><p>ชื่อโรค</p></center>
									<input type="text" name="disease[]" id="symptom"
										placeholder="กรุณากรอกชื่อโรค" class="form-control" required="required" />
